...
#											#
#	Public Version By: 	{Toxic } hacker portugal				#
#											#
#	Contact: 		www.facebook.com/tiago_nuno  			#
...
def wellcome_banner():
	print '========================================================================='
	print '|||||			 BruteGmail v.1.2			    	    |||||'
	print '========================================================================='
	print '|									|'
	print '| 	Author:	usem sem medo	       {Toxic} portugal hacker         |'
	print '|			                                             			|'
	print '|									|'
	print '| 	Release Date:	23-marco-2018					|'
	print '|									|'
	print '| 	Contact:	www.facebook.com/tiago_nuno		|'
	print '|			dimanmods1989@gmail.com				|'	
	print '|	 								|'
